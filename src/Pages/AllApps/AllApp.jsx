...
const AllApp = ({allApp}) => {
    const {id, image, title, companyName, downloads, ratingAvg} = allApp;
    const download = parseInt(downloads)/10000000;
    return (
        <Link to={`/appDetails/${id}`}>       
        <div className='bg-white p-5 rounded-2xl space-y-3 h-full'>
            <img src={image} alt={title} className='mx-auto w-[40%]'/>
            {/* <img className='mx-auto w-[30%]' src='logo.png' alt={title} /> */}
